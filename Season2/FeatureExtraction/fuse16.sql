...
create table temp1 as select user_id,item_id,ui_b1,ui_b2,ui_b3 from 16_ui_behavior_sum;
...
from temp1 a left outer join 16_ui_b1_hour_sum b
...
from temp2 a left outer join 16_ui_b2_hour_sum b
on a.user_id=b.user_id and a.item_id=b.item_id;
...
from temp3 a left outer join 16_ui_b3_hour_sum b
on a.user_id=b.user_id and a.item_id=b.item_id;

drop table if exists  temp5;
create table temp5 as select 
a.*,b.ua_b1,b.ua_b2,b.ua_b3
from temp4 a left outer join 16_ua_behavior_sum b
...
from temp5 a left outer join 16_ua_b1_hour_sum b
on a.user_id=b.user_id;
...
from temp6 a left outer join 16_ua_b2_hour_sum b
on a.user_id=b.user_id;
...
from temp7 a left outer join 16_ua_b3_hour_sum b
on a.user_id=b.user_id;
...
a.*,b.liveday
from temp11 a left outer join 16u_liveday b
on a.user_id=b.user_id;

drop table if exists temp13;
create table temp13 as select
a.*,b.ui_hb1,b.ui_hb2,b.ui_hb3,b.ui_hb4
from temp12 a left outer join 16ui_history b
on a.user_id=b.user_id and a.item_id=b.item_id;

-----------data----label

drop table if exists 17buylabel;
create table 17buylabel
as select user_id,item_id, count(*) as label
from 17buy group by user_id,item_id;

drop table if exists datalabel16;
create table  datalabel16
as select a.*,b.label
from temp13 a left outer join 17buylabel b
on a.user_id=b.user_id and a.item_id=b.item_id;
